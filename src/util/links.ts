...
const EXPLORER_ROUTES = {
  [ROUTES.TRANSACTION]: {
    [ChainId.MAINNET]: 'tx',
    [ChainId.BSCTESTNET]: 'tx',
    [ChainId.HECOMAINNET]: 'tx',
    [ChainId.HECOTESTNET]: 'tx',
    [ChainId.MATICMAINNET]: 'tx',
    [ChainId.MATICTESTNET]: 'tx',
    [ChainId.ETHEREUMMAINNET]: 'tx',
    [ChainId.ETHEREUMTESTNET]: 'tx',
    [ChainId.AURORAMAINNET]: 'tx',
    [ChainId.AURORATESTNET]: 'tx',
