...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg id="Capa_1" data-name="Capa 1" viewBox="0 0 473.68 473.68" {...props}>
      ...
      />
      <path
        d="M0,236.84H334.93C334.94,118.42,302.24,0,236.84,0,106,0,0,106,0,236.84Z"
        fill="#cd2029"
      />
      <path
        d="M319.77,236.84c0,118.42-17.53,236.84-82.94,236.84,130.81,0,236.85-106,236.85-236.84Z"
        fill="#e4e4e4"
      />
      <path
