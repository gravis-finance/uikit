...
const BrowserNotSupported: React.FC<{
  ...
  onDismiss?: any
  connect: any
}> = ({ supportedBrowsers, connect, onDismiss = () => null }) => {
  ...
  return (
    <Modal
      data-id="browser-not-supported-modal"
      title={t('Your browser does not support the wallet extension')}
      onDismiss={onDismiss}
    >
      <Container>
        ...
        <Text mt="20px">
          {t(
            'If you want to connect with this wallet you should use one of this browsers: '
          )}
